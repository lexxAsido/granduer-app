    ...
    <section className="flex flex-col gap-2 justify-around items-center lg:min-h-screen relative overflow-hidden">
      ...
      <div className="relative flex justify-center items-center bg-gray-100 py-5 shadow-lg shadow-black p-2 border 
        ...
        <div className="central-app flex flex-col items-center gap-3 justify-center">
          ...
          <FaMobileAlt  className="text-cyan-500 text-9xl max-lg:text-6xl" />
        ...
        <div className="absolute top-5 left-5">
          <FaLightbulb  className="text-yellow-500 animate-pulse text-7xl max-lg:text-4xl" />
        </div>
        <div className="absolute top-5 right-50">
          <FaCamera className="text-black animate-pulse text-7xl max-lg:text-4xl" />
        </div>
        <div className="absolute bottom-5 left-50">
          <GiTheaterCurtains  className="text-blue-700 animate-pulse text-7xl max-lg:text-4xl " />
        </div>
        <div className="absolute top-5 right-5">
          <FaThermometerHalf  className="text-red-500 animate-pulse text-7xl max-lg:text-4xl " />
        </div>
        <div className="absolute bottom-5 left-5">
          <GiWashingMachine className="text-gray-500 animate-pulse text-7xl max-lg:text-4xl" />
        </div>
        <div className="absolute bottom-5 right-5">
          <MdTv className="text-purple-500 animate-pulse text-7xl max-lg:text-4xl" />
        </div>
        <div className="absolute top-[40%] left-2">
          <MdOutlineCoffeeMaker  color="brown" className="animate-pulse text-7xl max-lg:text-4xl" />
        </div>
        <div className="absolute bottom-[40%] right-2">
          <PiSecurityCameraFill  className="text-green-500 animate-pulse text-7xl max-lg:text-4xl" />
        </div>
      </div>
    </section>
  );
